...
import { abi, RANDOMGAME_NFT_CONTRACT_ADDRESS } from "../constants"
...
export default function Home() {
  ...
  const startGame = async() => {
    try{
      ...
      const randomGameNFTContract = new Contract(RANDOMGAME_NFT_CONTRACT_ADDRESS,
        abi,
        signer)
  ...
  const joinGame = async() => {
    try{
      ...
      const randomGameNFTContract = new Contract(
        RANDOMGAME_NFT_CONTRACT_ADDRESS,
        abi,
        signer
      )
    ...
    <div>
      ...
      <div className={styles.main}>
        <div>
          ...
          <div className={styles.description}>            It's a lottery game where a winner is chosen at random and wins the
            entire lottery pool</div>
      ...
      <footer className={styles.footer}>Made with &#10084; by Colonexy</footer>
    </div>
